...
public class UserController {
     ...
     * @param session
     */
    // public void setUserSession(HttpServletRequest request, HttpServletResponse
    // response, Map<String, Object> userInfo,
    // HttpSession session) throws Exception {
    ...
    // // 사용자 ID
    // String PSN_ID = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("USER_ID")), "utf-8");
    // // 사용자명
    // String PSN_NM = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("USER_NAME")), "utf-8");
    // // 사용자이메일
    // String MAIL = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("EMAIL")), "utf-8");
    // // 직위명
    // String PSN_POSI_NM = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("POSITION")), "utf-8");
    // // 부서코드
    // String DEPT_CD = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("DEPT_ID")), "utf-8");
    // // 부서명
    // String DEPT_NM = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("DEPT_NAME")), "utf-8");
    // // 사무실 전화
    // String PSN_TEL = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("EXT_NUMBER")), "utf-8");
    // // 휴대폰번호
    // String PSN_HP = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("CELL_NUMBER")), "utf-8");
    // // 사용자 구분
    // String SVC_GB = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("USER_TYPE")), "utf-8");
    // // 권한그룹
    // String AUTH_GROUP = java.net.URLEncoder.encode(encrypter.encrypt((String)
    // userInfo.get("AUTH_GROUP")), "utf-8");
    // // 시스템 운영자 여부
    // String loginId = (String) userInfo.get("USER_ID");
    // String isSysMng = "N";
    // String manager = propertiesService.getString("MANAGER_ID"); // 시스템 운영자 아이디
    // 문자열
    // if (GlobalCom.isExist(manager, loginId))
    // isSysMng = "Y";
    // String IS_SYS_MNG = java.net.URLEncoder.encode(encrypter.encrypt(isSysMng),
    // "utf-8");
