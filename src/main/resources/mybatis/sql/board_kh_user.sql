...
CREATE TABLE `kh_user` (
  ...
  `user_loginpwd` varchar(100) NOT NULL COMMENT '사용자 로그인 비밀번호',
...
INSERT INTO `kh_user` VALUES (1,'user1','1234','유저1','user@mail.com','010-1111-2222','Seoul','서울은LG','001','user1','2022-05-17',NULL,NULL,'Y'),(2,'user2','1234','유저2','user2@mail.com','010-2222-3333','Daegu','대구는삼성','001','user2',NULL,NULL,NULL,'Y'),(3,'admin','1234','관리자','admin@naver.com','010-2333-4434','Daejun','대전은한화','005','admin','2022-05-20',NULL,NULL,'Y'),(4,'manager','1234','이정후','leejh@gmail.com','010-2444-5555','Gwangju','광주는기아','004','manager','2022-05-20',NULL,NULL,'Y');
...
-- Dump completed on 2022-05-20 14:26:13
